...
using TheHealMauiApp.Controls.Native;
...
[Scaffold(typeof(TheHealMauiApp.Controls.Native.BorderlessEntry))]
        ...
        return new Grid("*", "*")
        {
            new Border
            {
                new Grid("Auto, 78, Auto, Auto, *, Auto, Auto, 88", "*")
                {
                    ...
                    new FlexLayout()
                    {
                        new Image("logo_email"),
                        new Image("logo_apple"),
                        new Image("logo_google"),
                    }
